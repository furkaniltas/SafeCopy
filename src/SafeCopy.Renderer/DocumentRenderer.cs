...
public sealed class DocumentRenderer : IRenderer
{
    ...
    private readonly SafeCopy.Core.Abstractions.IVerificationEngine _verificationEngine;
    ...
    public DocumentRenderer(
        ...
        SafeCopy.Core.Abstractions.IVerificationEngine verificationEngine)
    {
