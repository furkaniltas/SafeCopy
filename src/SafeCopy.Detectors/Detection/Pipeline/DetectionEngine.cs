namespace SafeCopy.Detectors.Detection.Pipeline;

using SafeCopy.Core.Abstractions;
using SafeCopy.Core.Models;
using SafeCopy.Detectors.Detection.Detectors;
using SafeCopy.Detectors.Detection.PossiblePersonalData;
        ...
        try
        {
            ...
            if (_possibleAnalyzer != null)
            {
                ...
                foreach (var page in document.Pages)
                {
                    ...
                    var normalized = SafeCopy.Detectors.Detection.Normalization.TextNormalizer.NormalizeWithPositionTracking(pageText, new SafeCopy.Detectors.Detection.Normalization.NormalizationOptions
                    {
