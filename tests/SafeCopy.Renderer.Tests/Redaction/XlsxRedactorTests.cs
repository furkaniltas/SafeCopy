...
public class XlsxRedactorTests
{
    ...
    public async Task Xlsx_RealisticTcCell_EndToEndRedaction()
    {
        ...
        try
        {
            ...
            rendererServices.AddSingleton<IDocumentIngestor, SafeCopy.DocumentEngine.Ingestion.Xlsx.XlsxDocumentIngestor>();
            rendererServices.AddSingleton<IDocumentEngine, SafeCopy.DocumentEngine.Ingestion.DocumentEngine>();
