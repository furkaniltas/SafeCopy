...
public class Phase13RegressionTests
{
    private ServiceProvider CreateProvider()
    {
        ...
        services.AddOcr();
        services.AddBatch();
        services.AddSingleton<SafeCopy.App.Services.IFileDialogService, FakeFileDialogService2>();
        services.AddTransient<MainViewModel>();
        return services.BuildServiceProvider();
    }

    private class FakeFileDialogService2 : SafeCopy.App.Services.IFileDialogService
    {
    ...
    public void App_StartsMaximized()
    {
        ...
        var repoXaml = @"D:\SafeCopy\src\SafeCopy.App\MainWindow.xaml";
        ...
        {
            var xamlPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..", "..", "..", "..", "src", "SafeCopy.App", "MainWindow.xaml");
            ...
            else
            {
                ...
                typeof(SafeCopy.App.MainWindow).GetProperty("WindowState").Should().NotBeNull();
            }
        }
    }
